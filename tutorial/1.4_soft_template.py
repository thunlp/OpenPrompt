...
parser.add_argument("--project_root", default="/mnt/OpenPrompt_official/OpenPrompt/", help="The project root in the file system, i.e. the absolute path of OpenPrompt")
